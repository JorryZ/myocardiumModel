...
thickness_normal = [4.0220, 4.3017, 4.5815, 4.8613, 5.1410, 5.4208]
ratio_HFrEF = 1.1339

strain_longit = [20.0000, 18.0000, 16.0000, 14.0000, 12.0000, 10.0000, 8.0000, 6.0000]
strain_circum = [20.0000, 18.0000, 16.0000, 14.0000, 12.0000, 10.0000, 8.0000, 6.0000]

savePath = r'D:\3.HFpEF Pig-Teresa\MRI_HFpEF_HFrEF_sham\shellModel\sham476-D42\normal_strain-0.20-0.20_test3'
dataPath= r'D:\3.HFpEF Pig-Teresa\MRI_HFpEF_HFrEF_sham\shellModel\sham476-D42\shellModel.txt'
thickness_inner = 3.7938   # normal is 2
thickness_outer = 3.7938
strain=[-0.20,-0.20]    # shell strain value: longit. , circum.
...
# shell ES surface
interval, radius, coord, point = model.shellEndSystoleSolver(strain=strain)
